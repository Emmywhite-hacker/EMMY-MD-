const {
  ...
  const ownerNumber = ['2347078312023']
...
const sessdata = config.SESSION_ID.replace("EMMY-MD~", '');
...
const port = process.env.PORT || 9090;
  ...
  let up = `*Hello there EMMY-MD User! \ud83d\udc4b\ud83c\udffb* \n\n> Simple , Straight Forward But Loaded With Features \ud83c\udf8a, Meet EMMY-MD WhatsApp Bot.\n\n *Thanks for using EMMY-MD \ud83d\udea9* \n\n> Join WhatsApp Channel :- ⤵️\n \nhttps://whatsapp.com/channel/0029Vb6IGga7DAWse51nLk2U\n\n- *YOUR PREFIX:* = ${prefix}\n\nDont forget to give star to repo ⬇️\n\nhttps://github.com/Emmywhite-hacker/EMMY-MD-\n\n> © Powered BY EMMY WHITE \ud83d\udda4`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/ngfkvf.jpg` }, caption: up })
  }
  })
  ...
  const udp = botNumber.split('@')[0];
    const EMMY = ('2347078312023', '2349021693150', '2348166746236');
    let isCreator = [udp, emmy, config.DEV]
 ...
 //================ownerreact==============
  ...
  if(senderNumber.includes("2347078312023")){
  if(isReact) return
  m.react("🦋")
   }
  //==========public react============//
